...
export default function CartPage() {
  ...
  const deliveryAmount: number = data && data.length > 0 ? 5000 : 0
  ...
  //TODO item 나열 & item 정보 보여주기 & DB에 연결
  return (
    <div>
...
const Item = (props: cartItem) => {
  ...
  return (
    <div className="flex w-full p-4" style={{ borderBottom: '1px solid grey' }}>
      <Image
        src={props.image_url}
        width={150}
        height={150}
      ...
      <div className="flex flex-col ml-4">
        <span className="font-sem ibold mb-2">{props.name}</span>
